...
const HomePage = () => {
  return (
    <div className="grid lg:grid-cols-10 px-3 lg:px-0 gap-4">
      ...
      <div className="lg:col-span-7 lg:max-w-6xl mx-auto border lg:mt-0 sm:mt-6 mt-6">
        <p>
          Since beginning my journey as a freelance designer nearly 8 years ago,
          done rem remote work for agencies, consulted for startups, and
          collaborated with talented people to create digital products for both
          business and consumer use. m quietly confident, naturally curious, and
          ...
          consumer use. m quietly confident, naturally curious, and perpetually
          working on improving my chopsone design problem at a time. remote work
          ...
          m quietly confident, naturally curious, and perpetually working on
          improving my chopsone design problem at a time. remote work for
          agencies, consulted for startups, and collaborated with talented
          people to create digital products for both business and consumer use.
          m quietly confident, naturally curious, and perpetually working on
          improving my chopsone design problem at a time. reople to create
          digital products for both business and consumer use. m quietly
          confident, naturally curious, and perpetually working on improving my
          chopsone design problem at a time. remote work for agencies, consulted
          for startups, and collaborated with talented people to create digital
          products for both business and consumer use. m quietly confident,
          naturally curious, and perpetually working on improving my chopsone
          design problem at a time. remote work for agencies, consulted for
          startups, and collaborated with talented people to create digital
          products for both business and consumer use. m quietly confident,
          naturally curious, and perpetually working on improving my chopsone
          design problem at a time. reople to create digital products for both
          business and consumer use. m quietly confident, naturally curious, and
          perpetually working on improving my chopsone design problem at a time.
          remote work for agencies, consulted for startups, and collaborated
          with talented people to create digital products for both business and
          ...
          people to create digital products for both business and consumer use.
          m quietly confident, naturally curious, and perpetually working on
          improving my chopsone design problem at a time.ote work for agencies,
          consulted for startups, and collaborated with talented people to
          create digital products for both business and consumer use. m quietly
          confident, naturally curious, and perpetually working on improving my
